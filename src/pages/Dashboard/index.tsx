...
// useEffect - toda vez q quero executar uma função qd algo muda
// useCallback - qd quero retornar uma função
// useMemo - qd quero retornar um valor calculado
...
interface MonthAvailabitityItem {
  day: number;
  available: boolean;
}
